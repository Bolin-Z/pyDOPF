...
class Particle_C:
    def __init__(self, dimension:int) -> None:
        ...
        self.cost = float('inf')
        self.fit_9 = float('inf')
        self.fit_30 = float('inf')
        self.cost_9 = float('inf')
        self.cost_30 = float('inf')
    
    def __lt__(self, __o: "Particle_C") -> bool:
        return self.fitness < __o.fitness
    
    def __eq__(self, __o: "Particle_C") -> bool:
        return self.fitness == __o.fitness
...
class LLSO_C:
    ...
    def __init(self) -> None:
        ...
        self.swarm = [Particle_C(self._dimension) for _ in range(self.swarm_size)]
        for p in self.swarm:
